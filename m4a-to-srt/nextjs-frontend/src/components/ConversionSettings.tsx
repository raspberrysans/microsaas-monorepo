		...
		<div className="mt-8 space-y-6">
			...
			<div className="grid md:grid-cols-2 gap-6">
				...
				<div className="space-y-2">
					...
					<p className="text-xs text-gray-500 dark:text-gray-400">
						Number of words to include in each subtitle segment (1-50). Fewer
						words create more segments with shorter duration.
					</p>
				</div>
			...
			<div className="space-y-3">
				...
				<div className="flex flex-wrap gap-2">
					<button
						onClick={() =>
							onSettingsChange({ wordsPerSegment: 6, frameRate: 30.0 })
						}
						disabled={disabled}
					...
					<button
						onClick={() =>
							onSettingsChange({ wordsPerSegment: 8, frameRate: 30.0 })
						}
						disabled={disabled}
					...
					<button
						onClick={() =>
							onSettingsChange({ wordsPerSegment: 12, frameRate: 30.0 })
						}
						disabled={disabled}
						className="px-3 py-1 text-xs bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
					>
					...
					<button
						onClick={() =>
							onSettingsChange({
								wordsPerSegment: settings.wordsPerSegment,
								frameRate: 24.0,
							})
						}
						disabled={disabled}
			...
			<div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
				...
				<div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
					...
					<p>
						• Timing calculations will use <strong>{settings.frameRate}</strong>{' '}
						frames per second
					</p>
					<p>
